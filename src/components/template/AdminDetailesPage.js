...
function AdminDetailesPage({data: {title , address , description  , realState , amenities , rules , phoneNumber , category, price , createdAt}}) {
    const icons = {
        villa: <FcHome/>,
...
export default AdminDetailesPage
